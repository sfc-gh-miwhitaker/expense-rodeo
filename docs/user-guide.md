...
PUT file://sample_data/*.pdf @SNOWFLAKE_EXAMPLE.RECEIPT_EXTRACTOR.RECEIPTS_STAGE
  AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT file://sample_data/*.jpg @SNOWFLAKE_EXAMPLE.RECEIPT_EXTRACTOR.RECEIPTS_STAGE
  AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
...
`SNOWFLAKE_EXAMPLE.SEMANTIC_MODELS.SV_RECEIPT_EXTRACTOR`. Example questions:
